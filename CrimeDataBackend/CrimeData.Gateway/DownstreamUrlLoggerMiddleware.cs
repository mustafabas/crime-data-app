...
namespace CrimeData.Gateway
{
    public class DownstreamUrlLoggerMiddleware
    {
        private readonly ILogger<DownstreamUrlLoggerMiddleware> _logger;
        private readonly RequestDelegate _next;

        public DownstreamUrlLoggerMiddleware(RequestDelegate next, ILogger<DownstreamUrlLoggerMiddleware> logger)
        {
            _next = next;
            _logger = logger;
        }
